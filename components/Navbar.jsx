      ...
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-6 py-4">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <ul className={`flex ${isloggedin ? 'gap-10' : 'gap-4'} justify-between text-lg translate-y-[1px] font-medium text-gray-50`}>
            ...
            <li>
              {isloggedin && (<Link href = "/SaveMyRecipe" className="relative cursor-pointer after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-gray-50 after:transition-all after:duration-300 hover:after:w-full">My Recipes</Link>)}
            </li>
          </ul>
